...
void* worker () {
	...
	int worker_minerals, i , flag, main_status, others_status;	//Define worker_minerals (the minerals that the worker currently holds), i (a counter), flag (a bool like varible used inorder to reset worker's minerals)
